...
<div id="wrapper">
    ...
    <table id="keywords" cellspacing="0" cellpadding="0">
        ...
        $conn = connectdb();
        //正常显示
        $result = mysqli_query($conn, "SELECT * FROM engineers");
        //E_Name升序排列
...
<div class="container">
    <nav id="bt-menu" class="bt-menu">
        ...
        <ul>
            <li><a href="/../gecompetition/eng/allengineers.php" class="bt-icon icon-user-outline">All Eng</a></li>
            <li><a href="#" class="bt-icon icon-sun">Search Eng</a></li>
